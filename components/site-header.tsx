    ...
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/70">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4">
          ...
          >
            <span className="relative size-12 overflow-hidden rounded-lg ring-2 ring-primary/20 transition-shadow group-hover:ring-primary/40 sm:size-14">
              <Image
          ...
          <span className="hidden max-w-xs items-center border-l border-border/60 pl-4 text-sm leading-snug font-medium text-muted-foreground italic lg:flex">
